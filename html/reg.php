  	...
  	<div id="Container">
  		<div id="Login" class="Wrapper">
		 	...
		 	<img src="../img/finallogo.png">
				<form name="login" action="../Controllers/reg.php" method="POST" enctype="multipart/form-data" 	accept-charset="utf-8">
					<ul>					
						<li>
						...
						<li>
							...
							<input type="Ext" name="Ext" placeholder="Ext" required></li>
						<li>
							<label for="ProfilePicture">Profile Picture:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
							<input type="file" name="ProfilePicture" placeholder="ProfilePicture" required></li>
						<li>
